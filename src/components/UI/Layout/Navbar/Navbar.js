    ...
    <>
      <aside className={`navbar${sidebar ? " navbar-mini" : ""}`}>
        <div className={`navbar-header`}>
          ...
          <div
            className={`navbar-header-text${sidebar ? " hide-element" : ""}${
              (sidebar === false) & (sidebarAnimation === true) ? " show-element" : ""
            }`}
          >
            <div className="navbar-header-text-top">Twitch Helper</div>
            <div className="navbar-header-text-bottom">Workplace</div>
          </div>
        </div>
        ...
        <ul className={`links-tab${sidebar ? " minimized" : ""}`}>
          {SidebarData.map((item, index) => {
            if (item.type === "label") {
              return (
                <div
                  className={`links-tab-title${sidebar ? " hide-element" : ""}${
                    (sidebar === false) & (sidebarAnimation === true) ? " show-element" : ""
                  }`}
                >
                  {item.title}
        ...
        <div className="navbar-footer">
          ...
          <div
            className={`navbar-footer-close-btn ${sidebar && "navbar-footer-close-btn-minimized"} ${
              sidebarAnimation && "navbar-footer-close-btn-open-animation"
            }`}
            onClick={() => {
              setSidebar(!sidebar);
          ...
          <div
            className={`navbar-footer-text${sidebar ? " hide-element" : ""}${
              sidebar ? " hidden" : ""
            }`}
          >
            John Doe
